...
with left_column:
    st.subheader("Población económicamente activa PEA:")
    st.subheader("\u3164\u3164\u3164"f"{t1:,}")  
with right_column:
    st.subheader("PEA_Mujer:")
    st.subheader("\u3164\u3164\u3164"f"{t2:,}")
...
with left_column:
    ...
    st.subheader("\u3164\u3164\u3164"f"{t3:,}")  
with right_column:
    st.subheader("")
    st.subheader("")
    st.subheader("Población económica inactiva PE_INAC:")
    st.subheader("\u3164\u3164\u3164"f"{t4:,}")
    st.subheader("")
...
with left_column:
    ...
    st.subheader("\u3164\u3164\u3164"f"{t5:,}")
    st.subheader("")
with right_column:
    st.subheader("")
    st.subheader("")
    st.subheader("PE_INAC_Hombre:")
    st.subheader("\u3164\u3164\u3164"f"{t6:,}")      
...
with left_column:
    st.subheader("")
    st.subheader("")
    st.subheader("Población ocupada POCUPADA:")
    st.subheader("\u3164\u3164\u3164"f"{t7:,}")
    st.subheader("")
with right_column:
    st.subheader("")
    st.subheader("")
    st.subheader("POCUPADA_Mujer:")
    st.subheader("\u3164\u3164\u3164"f"{t8:,}")
    st.subheader("")
...
with left_column:
    ...
    st.subheader("\u3164\u3164\u3164"f"{t9:,}")    
with right_column:
    st.subheader("")
    st.subheader("")
    st.subheader("Población desocupada PDESOCUP:")
    st.subheader("\u3164\u3164\u3164"f"{t10:,}")
    st.subheader("")
...
with left_column:
    ...
    st.subheader("\u3164\u3164\u3164"f"{t11:,}")
    st.subheader("")
with right_column:
    st.subheader("")
    st.subheader("")
    st.subheader("PDESOCUP_Hombre:")
    st.subheader("\u3164\u3164\u3164"f"{t12:,}")       
